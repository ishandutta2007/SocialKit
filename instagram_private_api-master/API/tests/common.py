...
try:
    ...
    from API.instagram_private_api import Constants
    from API.instagram_private_api import compat_urllib_parse
except ImportError:
...
try:
    from API.instagram_web_api import (
    ...
    from API.instagram_web_api import compat_urllib_error
except ImportError:
    sys.path.append(os.path.join(os.path.dirname(__file__), '..'))
    from API.instagram_web_api import (
        __version__ as __webversion__,
